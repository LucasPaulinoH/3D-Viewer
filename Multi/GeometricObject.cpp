...
GeometricObject::GeometricObject(Geometry geometry, XMFLOAT4 color, uint viewportsQuantity, uint constantBufferSize) 
...
void GeometricObject::changeGOColor(XMFLOAT4 color) {
